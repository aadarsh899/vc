...
public class FileUploader {
    ...
    public FileUploader(File file, Context context, UploadVideoModel uploadModel) {
        ...
        Log.d("ROHITH", "FileUploader: upload id is "+uploadModel.getVideoId());
        ...
        fileUpload.enqueue(new Callback<UploadResponse>() {
            ...
            public void onFailure(Call<UploadResponse> call, Throwable t) {
                Log.d("ROHITH", "onFailure: failed error os "+call.toString());
                Log.d("ROHITH", "onFailure: uploading error is "+t.getLocalizedMessage());
