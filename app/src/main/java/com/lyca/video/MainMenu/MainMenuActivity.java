...
public class MainMenuActivity extends AppCompatActivity {
    ...
    private void chechDeepLink(Intent intent) {
        try {
            ...
            String userId="";
            String videoId="";
            String profileURL=Variables.http+"://"+getString(R.string.share_profile_domain)+getString(R.string.share_profile_endpoint_second);
    ...
    private void OpenProfileScreen(String userId) {
        ...
        ApiRequest.callApi(MainMenuActivity.this, ApiLinks.showUserDetail, parameters, new Callback() {
            @Override
    ...
    public void getPublicIP() {
        ApiRequest.callApiGetRequest(this, "https://api.ipify.org/?format=json", new Callback() {
            @Override
            public void onResponce(String resp) {
                try {
    ...
    public void checkLicence(){
        ...
        ApiRequest.callApi(MainMenuActivity.this, ApiLinks.showLicense, null, new Callback() {
            @Override
            public void onResponce(String resp) {
                try {
                    JSONObject jsonObject=new JSONObject(resp);
