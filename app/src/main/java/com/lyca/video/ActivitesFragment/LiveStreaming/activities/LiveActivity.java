package com.lyca.video.ActivitesFragment.LiveStreaming.activities;
...
import com.lyca.video.ActivitesFragment.LiveStreaming.LiveCommentModel;
import com.lyca.video.ActivitesFragment.LiveStreaming.LiveCommentsAdapter;
import com.lyca.video.ActivitesFragment.LiveStreaming.LiveUserModel;
import com.lyca.video.ActivitesFragment.LiveStreaming.LiveUserViewAdapter;
import com.lyca.video.ActivitesFragment.LiveStreaming.stats.LocalStatsData;
import com.lyca.video.ActivitesFragment.LiveStreaming.stats.RemoteStatsData;
import com.lyca.video.ActivitesFragment.LiveStreaming.stats.StatsData;
import com.lyca.video.ActivitesFragment.LiveStreaming.ui.VideoGridContainer;
import com.lyca.video.ActivitesFragment.SendGift.StickerGiftF;
import com.lyca.video.ActivitesFragment.SendGift.StickerModel;
...
public class LiveActivity extends RtcBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(com.lyca.video.Constants.STREAMING_LIMIT)
        {
            try {
               if (userRole == Constants.CLIENT_ROLE_BROADCASTER)
               {
                   ...
                   },com.lyca.video.Constants.MAX_STREMING_TIME);
               }
            }
            catch (Exception e)
            {
                Log.d(com.lyca.video.Constants.tag,"Exception streaming : "+e);
            }
        }
    }
        ...
        joinValueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists())
                {
                    ...
                    {
                        Log.d(com.lyca.video.Constants.tag,"Data JSON : "+joinSnapsot.getValue().toString());
    ...
    private void initUI() {
        ...
        Functions.printLog(com.lyca.video.Constants.tag, "initUI");
        ...
        rtcEngine().setBeautyEffectOptions(isbeautyActivated,
                com.lyca.video.ActivitesFragment.LiveStreaming.Constants.DEFAULT_BEAUTY_OPTIONS);
    ...
    private void initUserIcon() {
        Functions.printLog(com.lyca.video.Constants.tag, "initUserIcon");
    ...
    private void initData() {
        Functions.printLog(com.lyca.video.Constants.tag, "initData");
        mVideoDimension = com.lyca.video.ActivitesFragment.LiveStreaming.Constants.VIDEO_DIMENSIONS[
    ...
    public void onFirstRemoteVideoDecoded(final int uid, int width, int height, int elapsed) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Functions.printLog(com.lyca.video.Constants.tag, "onFirstRemoteVideoDecoded");
    ...
    private void renderRemoteUser(int uid) {
        Functions.printLog(com.lyca.video.Constants.tag, "renderRemoteUser");
    ...
    public void onRtcStats(IRtcEngineEventHandler.RtcStats stats) {
        Functions.printLog(com.lyca.video.Constants.tag, "onRtcStats");
        if (!statsManager().isEnabled()) return;
    ...
    public void onNetworkQuality(int uid, int txQuality, int rxQuality) {
        Functions.printLog(com.lyca.video.Constants.tag, "onNetworkQuality");
        if (!statsManager().isEnabled()) return;
    ...
    public void onRemoteVideoStats(IRtcEngineEventHandler.RemoteVideoStats stats) {
        Functions.printLog(com.lyca.video.Constants.tag, "onRemoteVideoStats");
        if (!statsManager().isEnabled()) return;
    ...
    public void onRemoteAudioStats(IRtcEngineEventHandler.RemoteAudioStats stats) {
        Functions.printLog(com.lyca.video.Constants.tag, "onRemoteAudioStats");
        if (!statsManager().isEnabled()) return;
            ...
            public void onResponce(Bundle bundle) {
                ...
                else
                {
                    if (bundle.getBoolean("showCount",false))
                    {
                        ...
                        Glide.with(LiveActivity.this).load(model.image)
                                .error(R.drawable.ic_gift_send)
    ...
    private void ShowGiftAnimation(LiveCommentModel item) {
        ...
        Glide.with(LiveActivity.this).load(imageUri)
                .error(R.drawable.ic_gift_send)
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .into(ivGiftItem);
        ...
        tabGiftMain.animate().translationX(animationGiftCapture.getX()).setDuration(1500).setListener(
                new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        super.onAnimationEnd(animation);
                        tabGiftMain.animate().translationY(animationCapture.getY()).setDuration(700).setListener(new AnimatorListenerAdapter() {
                            @Override
                            public void onAnimationEnd(Animator animation) {
                                super.onAnimationEnd(animation);
                                tabGiftMain.animate().translationY(0).translationX(0);
                                tabGiftMain.setAlpha(0);
    ...
    public void sendLiveNotification() {
        ...
        ApiRequest.callApi(this, ApiLinks.sendLiveStreamPushNotfication, params, null);
