...
import com.lyca.video.ActivitesFragment.LiveStreaming.ui.ResolutionAdapter;
...
import static com.lyca.video.ActivitesFragment.LiveStreaming.Constants.PREF_RESOLUTION_IDX;
...
public class SettingsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(SettingsActivity.this).getString(Variables.APP_LANGUAGE_CODE,Variables.DEFAULT_LANGUAGE_CODE)
                , this, SettingsActivity.class,false);
