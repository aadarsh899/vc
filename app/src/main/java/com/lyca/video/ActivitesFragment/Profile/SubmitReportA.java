...
public class SubmitReportA extends AppCompatActivity implements View.OnClickListener {
    ...
    public void callApiReportVideo() {
        ...
        ApiRequest.callApi(SubmitReportA.this, ApiLinks.reportVideo, params, new Callback() {
            @Override
    ...
    public void callApiReportUser() {
        ...
        Functions.showLoader(SubmitReportA.this, false, false);
        ApiRequest.callApi(SubmitReportA.this, ApiLinks.reportUser, params, new Callback() {
            @Override
            public void onResponce(String resp) {
                Functions.cancelLoader();
