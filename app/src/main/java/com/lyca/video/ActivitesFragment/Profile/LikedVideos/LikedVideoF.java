package com.lyca.video.ActivitesFragment.Profile.LikedVideos;
...
import com.lyca.video.ActivitesFragment.Profile.SettingAndPrivacyA;
...
public class LikedVideoF extends Fragment {
    ...
    private void callApiLikedvideos() {
        ...
        ApiRequest.callApi(getActivity(), ApiLinks.showUserLikedVideos, parameters, new Callback() {
            @Override
