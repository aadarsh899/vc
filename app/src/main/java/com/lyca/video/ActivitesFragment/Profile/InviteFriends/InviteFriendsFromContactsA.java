package com.lyca.video.ActivitesFragment.Profile.InviteFriends;
...
import com.lyca.video.ActivitesFragment.Profile.ProfileA;
import com.lyca.video.Adapters.FollowingAdapter;
import com.lyca.video.Adapters.InviteFriendAdapter;
import com.lyca.video.Adapters.ProfileSharingAdapter;
import com.lyca.video.ApiClasses.ApiLinks;
import com.lyca.video.ApiClasses.ApiRequest;
import com.lyca.video.Constants;
import com.lyca.video.Interfaces.APICallBack;
import com.lyca.video.Interfaces.AdapterClickListener;
import com.lyca.video.Models.FollowingModel;
import com.lyca.video.Models.InviteFriendModel;
import com.lyca.video.Models.ShareAppModel;
...
public class InviteFriendsFromContactsA extends AppCompatActivity implements View.OnClickListener {
    ...
    public void shareProfile(ShareAppModel item) {
        String profielLink = Variables.http+"://"+getString(R.string.share_profile_domain)+getString(R.string.share_profile_endpoint) + Functions.getSharedPreference(InviteFriendsFromContactsA.this).getString(Variables.U_ID,"");
    ...
    private void hitFacebookInvitationContactApi(JSONArray contactJSON) {
        ...
        ApiRequest.callApi(InviteFriendsFromContactsA.this, ApiLinks.showRegisteredContacts, parameters, resp -> {
