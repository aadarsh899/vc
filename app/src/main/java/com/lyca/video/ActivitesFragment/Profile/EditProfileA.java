...
import com.lyca.video.Interfaces.KeyboardHeightObserver;
...
import com.lyca.video.SimpleClasses.KeyboardHeightProvider;
...
public class EditProfileA extends AppCompatActivity implements View.OnClickListener{
    ...
    public void callApiForImage() {
        ...
        ApiRequest.callApi(EditProfileA.this, ApiLinks.addUserImage, parameters, new Callback() {
            @Override
