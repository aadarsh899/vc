...
import com.lyca.video.Adapters.SoundsAdapter;
import com.lyca.video.Constants;
import com.lyca.video.MainMenu.RelateToFragmentOnBack.RootFragment;
import com.lyca.video.Models.SoundCatagoryModel;
import com.lyca.video.Models.SoundsModel;
...
public class DiscoverSoundListF extends RootFragment implements Player.Listener {
    ...
    private void callApiForGetAllsound() {
        ...
        ApiRequest.callApi(getActivity(), ApiLinks.showSounds, parameters, resp -> {
    ...
    private void callApiForFavSound(final SoundsModel item) {
        ...
        ApiRequest.callApi(getActivity(), ApiLinks.addSoundFavourite, parameters, new Callback() {
            @Override
