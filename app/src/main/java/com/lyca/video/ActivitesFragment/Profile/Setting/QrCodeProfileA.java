...
import com.lyca.video.ActivitesFragment.Profile.ShareItemViaIntentA;
import com.lyca.video.Constants;
import com.lyca.video.Interfaces.ShareIntentCallback;
import com.lyca.video.R;
import com.lyca.video.SimpleClasses.Functions;
import com.lyca.video.SimpleClasses.ImageSaver;
...
public class QrCodeProfileA extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inItControl();
        String profielLink = Variables.http+"://"+getString(R.string.share_profile_domain)+getString(R.string.share_profile_endpoint_second) + Functions.getSharedPreference(QrCodeProfileA.this).getString(Variables.U_ID,"");
    ...
    private void setUpScreenData() {
        ...
        if (!imgUrl.contains(Variables.http)) {
            imgUrl = Constants.BASE_URL + imgUrl;
        }
        Glide.with(QrCodeProfileA.this)
                .load(imgUrl)
    ...
    private void GenrateQrCode(ImageView img_qr, String qr_string) {
