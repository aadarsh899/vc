...
import com.lyca.video.ActivitesFragment.Profile.InviteFriends.InviteFriendsFromContactsA;
import com.lyca.video.ActivitesFragment.Profile.Setting.NoInternetA;
import com.lyca.video.ActivitesFragment.Profile.Setting.QrCodeScannerA;
...
public class InviteFriendsA extends AppCompatActivity implements View.OnClickListener {
    ...
    public void callSuggestionApi() {
        ...
        ApiRequest.callApi(InviteFriendsA.this, ApiLinks.showSuggestedUsers, parameters, new Callback() {
            @Override
