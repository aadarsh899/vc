...
public class TagedVideosA extends AppCompatActivity implements View.OnClickListener {
    ...
    private void callApiForGetAllvideos(boolean isProgressShow) {
        ...
        ApiRequest.callApi(TagedVideosA.this, ApiLinks.showVideosAgainstHashtag, parameters, new Callback() {
            @Override
    ...
    public void callApiFavHashtag() {
        ...
        ApiRequest.callApi(TagedVideosA.this, ApiLinks.addHashtagFavourite, params, new Callback() {
            @Override
            public void onResponce(String resp) {
