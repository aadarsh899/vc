...
import com.lyca.video.Adapters.ReportTypeAdapter;
...
import com.lyca.video.Models.ReportTypeModel;
...
public class ReportTypeA extends AppCompatActivity implements View.OnClickListener {
    ...
    private void callApiForGetReportType() {
        ...
        ApiRequest.callApi(ReportTypeA.this, ApiLinks.showReportReasons, parameters, new Callback() {
            @Override
