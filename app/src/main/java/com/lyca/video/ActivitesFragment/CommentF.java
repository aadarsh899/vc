...
import com.lyca.video.Adapters.CommentsAdapter;
...
import com.lyca.video.Models.CommentModel;
...
import com.lyca.video.SimpleClasses.SoftKeyboardStateHelper;
...
public class CommentF extends RootFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d(Constants.tag,"Test : "+item.apply_privacy_model.getVideo_comment());
        Log.d(Constants.tag,"Test : "+item.follow_status_button);
    ...
    public void getAllComments() {
        ...
        ApiRequest.callApi(getActivity(), ApiLinks.showVideoComments, parameters, new Callback() {
            @Override
