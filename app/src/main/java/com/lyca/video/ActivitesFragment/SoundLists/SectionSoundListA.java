...
import com.lyca.video.Adapters.SoundListAdapter;
...
public class SectionSoundListA extends AppCompatActivity implements Player.Listener, View.OnClickListener{
    ...
    public void callApi() {
        ...
        ApiRequest.callApi(SectionSoundListA.this, ApiLinks.showSoundsAgainstSection, params, new Callback() {
            @Override
    ...
    private void callApiForFavSound(final int pos, final SoundsModel item) {
        ...
        ApiRequest.callApi(SectionSoundListA.this, ApiLinks.addSoundFavourite, parameters, new Callback() {
            @Override
            public void onResponce(String resp) {
