...
import com.lyca.video.ActivitesFragment.LiveStreaming.LiveUserAdapter;
import com.lyca.video.ActivitesFragment.LiveStreaming.LiveUserModel;
import com.lyca.video.ActivitesFragment.LiveStreaming.activities.LiveActivity;
...
import com.lyca.video.SimpleClasses.TicTic;
...
public class LiveUsersA extends AppCompatActivity implements View.OnClickListener {
    ...
    public void openTicTicLive(String userId, String userName, String userImage, int role) {
        ...
        intent.putExtra(com.lyca.video.ActivitesFragment.LiveStreaming.Constants.KEY_CLIENT_ROLE, role);
