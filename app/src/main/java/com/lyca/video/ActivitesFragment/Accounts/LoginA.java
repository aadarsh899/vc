...
//                .requestIdToken(getString(R.string.google_web_client_id))
        ...
        if (account != null) {
            ...
            Log.d(TAG, "signInWithGmail: "+auth_token);
            ...
            Log.d(TAG, "signInWithGmail: null valled ");
    ...
    ActivityResultLauncher<Intent> resultCallbackForGoogle = registerForActivityResult(
            new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    Log.d("ROHITH", "onActivityResult: result code and result is "+result.getResultCode());
                    Log.d("ROHITH", "onActivityResult: result message is "+result.toString()+result.getData().toString());
                    Log.d("ROHITH", "onActivityResult: "+Activity.RESULT_OK);
...
//                    }
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        try {
            ...
            if (account != null) {
                Log.d(TAG, "handleSignInResult: account not null");
                String id = ""+account.getId();
                String fname = "" + account.getGivenName();
                String lname = "" + account.getFamilyName();
                String auth_token = ""+account.getIdToken();
            ...
            Log.d(TAG, "handleSignInResult: error is "+e.toString());
