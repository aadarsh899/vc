package com.lyca.video.ActivitesFragment.Profile.Favourite;
...
import com.lyca.video.Adapters.VideosListAdapter;
...
public class FavouriteVideosF extends Fragment {
    ...
    public void callApi() {
        ...
        ApiRequest.callApi(getActivity(), ApiLinks.showFavouriteVideos, params, new Callback() {
            @Override
