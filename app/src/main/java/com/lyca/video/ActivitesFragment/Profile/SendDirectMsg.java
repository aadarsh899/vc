...
import com.lyca.video.Adapters.UserShareProfileAdapter;
...
public class SendDirectMsg extends AppCompatActivity implements  View.OnClickListener{
    ...
    private void callApiForGetAllSearchUser() {
        ...
        ApiRequest.callApi(SendDirectMsg.this, ApiLinks.searchFollowingOrFollowUsers, parameters, new Callback() {
            @Override
        ...
        try {
            ...
            if (code.equals("200")) {
                ...
                for (int i = 0; i < msgArray.length(); i++) {
                    ...
                    JSONObject FollowingList = object.optJSONObject("User");
    ...
    private void callApiForGetAllfollower() {
        ...
        ApiRequest.callApi(SendDirectMsg.this, ApiLinks.showFollowers, parameters, new Callback() {
            @Override
            public void onResponce(String resp) {
    ...
    private void callApiForGetAllfollowing() {
        ...
        ApiRequest.callApi(SendDirectMsg.this, ApiLinks.showFollowing, parameters, new Callback() {
            @Override
            public void onResponce(String resp) {
            ...
            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                ...
                rootref.updateChildren(both_user_map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        ApiRequest.callApi(SendDirectMsg.this, ApiLinks.sendPushNotification, notimap, new Callback() {
                            @Override
                            public void onResponce(String resp) {
