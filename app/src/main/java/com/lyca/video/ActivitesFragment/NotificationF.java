...
import com.lyca.video.Adapters.NotificationAdapter;
...
import com.lyca.video.Models.NotificationModel;
...
public class NotificationF extends RootFragment implements View.OnClickListener {
    ...
    public void callApi() {
        ...
        ApiRequest.callApi(getActivity(), ApiLinks.showAllNotifications, jsonObject, new Callback() {
            @Override
