...
public class PrivacyPolicySettingA extends AppCompatActivity implements View.OnClickListener {
    ...
    public void callApi() {
        ...
        ApiRequest.callApi(PrivacyPolicySettingA.this, ApiLinks.addPolicySetting, params, new Callback() {
            @Override
