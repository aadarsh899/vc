...
import com.lyca.video.Adapters.UsersAdapter;
...
import com.lyca.video.Models.UsersModel;
...
public class FriendsA extends AppCompatActivity {
    ...
    private void callApiForOtherUsers() {
        ...
        ApiRequest.callApi(FriendsA.this, ApiLinks.search, parameters, new Callback() {
            @Override
    ...
    private void callApiForGetAllfollowing(boolean isProgressShow) {
        ...
        ApiRequest.callApi(FriendsA.this, ApiLinks.showFollowing, parameters, new Callback() {
            @Override
            public void onResponce(String resp) {
                if (isProgressShow)
                {
