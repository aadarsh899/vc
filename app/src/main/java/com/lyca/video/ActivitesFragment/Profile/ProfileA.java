...
import com.lyca.video.ActivitesFragment.Chat.ChatA;


import com.lyca.video.ActivitesFragment.Profile.FollowTab.NotificationPriorityF;
import com.lyca.video.ActivitesFragment.Profile.LikedVideos.LikedVideoF;
import com.lyca.video.ActivitesFragment.Profile.UserVideos.UserVideoF;
import com.lyca.video.ActivitesFragment.WebviewA;
import com.lyca.video.Adapters.SuggestionAdapter;
...
import com.lyca.video.Models.PrivacyPolicySettingModel;
import com.lyca.video.Models.PushNotificationSettingModel;
...
public class ProfileA extends AppCompatActivity implements View.OnClickListener  {
    ...
    private void getSuggestionUserList() {
        ...
        ApiRequest.callApi(ProfileA.this, ApiLinks.showSuggestedUsers, parameters, new Callback() {
            @Override
    ...
    private void callApiForGetAllvideos() {
        ...
        ApiRequest.callApi(ProfileA.this, ApiLinks.showUserDetail, parameters, new Callback() {
            @Override
            public void onResponce(String resp) {
                isRunFirstTime = true;
                parseData(resp);
