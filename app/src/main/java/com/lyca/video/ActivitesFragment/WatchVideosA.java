...
public class WatchVideosA extends AppCompatActivity implements View.OnClickListener,FragmentCallBack {
    ...
    private void callApiForSoundVideos() {
        ...
        ApiRequest.callApi(WatchVideosA.this, ApiLinks.showVideosAgainstSound, parameters, new Callback() {
            @Override
            public void onResponce(String resp) {
                swiperefresh.setRefreshing(false);
    ...
    private void callApiForTagedVideos() {
        ...
        ApiRequest.callApi(WatchVideosA.this, ApiLinks.showVideosAgainstHashtag, parameters, new Callback() {
            @Override
            public void onResponce(String resp) {
                swiperefresh.setRefreshing(false);
    ...
    private void callApiForUserVideos() {
        ...
        ApiRequest.callApi(WatchVideosA.this, ApiLinks.showVideosAgainstUserID, parameters, new Callback() {
            @Override
            public void onResponce(String resp) {
                swiperefresh.setRefreshing(false);
    ...
    private void callApiForLikedVideos() {
        ...
        ApiRequest.callApi(WatchVideosA.this, ApiLinks.showUserLikedVideos, parameters, new Callback() {
            @Override
            public void onResponce(String resp) {
                swiperefresh.setRefreshing(false);
