package com.lyca.video;

public class Constants {

    public static final String BASE_URL ="http://3.108.30.45/mobileapp_api/";
    ...
    public static final String Product_ID1="com.lyca.videotwo";

    public static final String COINS2="2000";
    public static final String PRICE2="$20";
    public static final String Product_ID2="com.lyca.videothree";

    public static final String COINS3="5000";
    public static final String PRICE3="$50";
    public static final String Product_ID3="com.lyca.videofour";

    public static final String COINS4="10000";
    public static final String PRICE4="$100";
    public static final String Product_ID4="com.lyca.videofive";
