package com.lyca.video.Services;
...
import com.lyca.video.ApiClasses.FileUploader;
import com.lyca.video.Constants;
import com.lyca.video.MainMenu.MainMenuActivity;
import com.lyca.video.Models.UploadVideoModel;
                ...
                public void run() {
                    ...
                    fileUploader.SetCallBack(new FileUploader.FileUploaderCallback() {
                        ...
                        public void onError() {
                            ...
                            Log.d(TAG, "onError: erroor while uploading is ");
                            stopForeground(true);
                            stopSelf();
                        ...
                        public void onFinish(String responses) {
                            ...
                            try {
                                ...
                                Log.d(TAG, "onFinish: code is "+code);
