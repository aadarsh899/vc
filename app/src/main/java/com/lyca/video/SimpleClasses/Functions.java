...
import com.lyca.video.ActivitesFragment.LiveStreaming.CallBack;
...
import com.lyca.video.Models.MultipleAccountModel;
    ...
    public static void RegisterConnectivity(Context context, final InternetCheckCallback callback) {
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                Log.d("ROHITH", "onReceive: connected to internet "+isConnectedToInternet(context));
